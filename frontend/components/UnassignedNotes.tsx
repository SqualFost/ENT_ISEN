...
export function UnassignedNotes({
  ...
  const [selectedModuleForSousMatiere, setSelectedModuleForSousMatiere] =
    useState("");
  const [selectedMatiereForSousMatiere, setSelectedMatiereForSousMatiere] =
    useState("");
  ...
  const handleCreateMatiere = () => {
    if (newMatiereName.trim() && selectedModuleForMatiere && newMatiereCoeff) {
      onCreateMatiere(
        selectedModuleForMatiere,
        newMatiereName.trim(),
        Number.parseFloat(newMatiereCoeff)
      );
      setNewMatiereName("");
      setNewMatiereCoeff("");
    ...
    <Card className="border-dashed border-2 border-orange-300 bg-orange-50/50">
      <CardHeader>
        ...
        <p className="text-sm text-orange-600">
          Ces notes n&apos;ont pas encore été assignées à un module.
          Assignez-les directement ci-dessous.
        </p>
      </CardHeader>
      <CardContent>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span
                        className={`font-bold ${getCouleurNote(
                          Number.parseFloat(note.score)
                        )}`}
                      >
                        {note.score}/20
                      </span>
          ...
          {showCreateMatiere && (
            <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <div className="grid gap-2">
                <Select
                  value={selectedModuleForMatiere}
                  onValueChange={setSelectedModuleForMatiere}
                >
                  <SelectTrigger>
          ...
          {showCreateSousMatiere && (
            <div className="mt-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
              <h4 className="font-medium text-purple-800 mb-2">
                Créer une nouvelle sous-matière
              </h4>
              <div className="grid gap-2">
                <Select
                  value={selectedModuleForSousMatiere}
                  onValueChange={setSelectedModuleForSousMatiere}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Sélectionner un module" />
                  </SelectTrigger>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => setShowCreateSousMatiere(false)}
                  >
                    Annuler
                  </Button>
                </div>
